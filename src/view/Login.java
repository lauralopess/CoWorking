...
public class Login extends JDialog {
	...
	public Login() {
		...
		setTitle("Login");
		setResizable(false);
		setBounds(new Rectangle(0, 0, 461, 335));
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/img/logo.png")));
		getContentPane().setLayout(null);

		JLabel txtLogin = new JLabel("Login:");
		txtLogin.setHorizontalAlignment(SwingConstants.CENTER);
		txtLogin.setBounds(41, 109, 125, 14);
		getContentPane().add(txtLogin);

		JLabel txtSenha = new JLabel("Senha:");
		txtSenha.setHorizontalAlignment(SwingConstants.CENTER);
		txtSenha.setBounds(41, 163, 125, 14);
		getContentPane().add(txtSenha);

		inputLogin = new JTextField();
		inputLogin.setBounds(135, 106, 212, 20);
		getContentPane().add(inputLogin);
		inputLogin.setColumns(10);

		inputSenha = new JPasswordField();
		inputSenha.setBounds(135, 160, 212, 20);
		getContentPane().add(inputSenha);

		JButton btnLogin = new JButton("Entrar");
		btnLogin.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnLogin.setFont(new Font("Yu Gothic UI", Font.BOLD, 12));
		btnLogin.setBounds(181, 225, 89, 23);
		...
		tituloLogin.setFont(new Font("Yu Gothic UI", Font.BOLD, 16));
		tituloLogin.setHorizontalAlignment(SwingConstants.CENTER);
		tituloLogin.setBounds(0, 38, 444, 20);
		...
		imgDatabase.setBounds(10, 236, 53, 59);
